...
export type ThreadPitch = number;
export type ThreadRotationRadius = number;
export type ThreadSupportDiameter = number;
export type ThreadSpecs = [
  ThreadPitch,
  ThreadRotationRadius,
  ThreadSupportDiameter,
  ThreadSectionProfile,
];

type ThreadSectionProfileReadOnly = readonly[
...
type ThreadSpecsReadOnly = readonly [
  ThreadPitch,
  ThreadRotationRadius,
  ThreadSupportDiameter,
  ThreadSectionProfileReadOnly,
];
...
// extract keys from THREAD_TABLE.
type ExtractDesignator<T> = T extends readonly (readonly [infer D, unknown])[]
  ? D
  : never;

export type ThreadDesignator = ExtractDesignator<typeof _THREAD_TABLE>;

export const THREAD_TABLE: readonly (readonly [
  ThreadDesignator,
  ThreadSpecsReadOnly,
])[] = _THREAD_TABLE;
